...
setx THIRDPARTY_INCLUDE %INCLUDE% /m

setx THIRDPARTY_BIN %BIN_RELEASE% /m
setx THIRDPARTY_LIB %BIN_RELEASE% /m

setx THIRDPARTY_BIN_RELEASE %BIN_RELEASE% /m
setx THIRDPARTY_LIB_RELEASE %BIN_RELEASE% /m

setx THIRDPARTY_BIN_DEBUG %BIN_DEBUG% /m
setx THIRDPARTY_LIB_DEBUG %BIN_DEBUG% /m

setx PATH %PATH%;%THIRDPARTY_BIN%
